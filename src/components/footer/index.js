        ...
        <>
            <section className={classes.contactsSection}>
                ...
                <div>
                    ...
                    <motion.div viewport={{ once: true }} initial={{ transform: 'translateY(4rem)', opacity: 0 }} whileInView={{ transform: 'translateY(0rem)', opacity: 1 }} transition={{ duration: 1.5, type: "spring", delay: 0.6 }} className={classes.socialContact}><a rel="noreferrer" target="_blank" href="https://www.youtube.com/@AdvaitaIIITBhubaneswar">YOUTUBE</a></motion.div>
            ...
            <section className={classes.footerSection}>
                <div><span style={{ color: "#3c3556" }}>© 2K24</span> TECH SOCIETY - IIIT-Bh</div>
                <div style={{ color: "#3c3556" }}>TECH SOCIETY, IIIT BBSR, GOTHAPATNA - 751003</div>
            </section>
        </>
    );
}